  ...
  )
{
  ...
  //
  // Loongson branded banner: gold on blue, centered (vendor style).
  //
  Line = gScreenDimensions.TopRow + 1;
  Col  = (gScreenDimensions.RightColumn - gScreenDimensions.LeftColumn - 35) / 2;
  PrintStringAt (Col, Line, L"LOONGSON 2K1000LA  EDUCATION BOARD");
