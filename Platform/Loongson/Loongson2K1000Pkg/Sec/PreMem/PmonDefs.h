...
/* Mirrors: every character also goes to the remaining three ports. */
#define COM1_MIRROR0_ADDR     PHYS_TO_UNCACHED(LS2K1000_UART0_PHYS)
#define COM1_MIRROR1_ADDR     PHYS_TO_UNCACHED(LS2K1000_UART4_PHYS)
#define COM1_MIRROR2_ADDR     PHYS_TO_UNCACHED(LS2K1000_UART5_PHYS)
